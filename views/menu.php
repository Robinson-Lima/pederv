...
function acompanharPedido(){const url=localStorage.getItem('rv_last_status_url');const id=localStorage.getItem('rv_last_order');if(url)location.href=url;else if(id)location.href='?r=order_status&id='+id;else alert('Você ainda não fez um pedido neste aparelho.')}
